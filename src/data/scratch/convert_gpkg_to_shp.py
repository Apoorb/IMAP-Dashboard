...
if __name__ == "__main__":
    ...
    path_hpms_visual_checks = os.path.join(
    ...
    hpms_2018_nc_fil_all = gpd.read_file(path_hpms_visual_checks, driver="gpkg")
    ...
    hpms_2018_nc_fil_all.to_file(
        os.path.join(path_interim_sratch, "hpms_2018_nhs_stc_gis_visual_check.shp")
    )
